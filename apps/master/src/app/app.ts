...
import { ParseAPI, PatchAPI, AdminAPI, W3StatsAPI, W3AliasAPI, TwitchAuthAPI, PaypalAPI, BattleNetAuthAPI, StripeAPI, GiftAPI } from './apis';
...
app.use('/gift', new GiftAPI(app).getHandler());
