...
//ORIGINAL LINE: [StructLayout(LayoutKind.Sequential, Pack = 1)] public unsafe struct UnitInfo
...
//
//		public const int SIZE = sizeof(uint) + MAX_NAME_LENGTH * sizeof(byte) + sizeof(uint) + sizeof(uint) + sizeof(uint) + MAX_BUTTON_ART_LENGTH * sizeof(byte) + sizeof(byte) + sizeof(byte) + sizeof(uint) + sizeof(uint) + sizeof(uint);
//
...
//			get
//			{
//				return this.isPeon != 0;
//			}
//		}
//
//		public bool IsFunctionalPeon
//		{
//			get
//			{
//				return this.isFunctionalPeon != 0;
//			}
//		}
//
