...
//ORIGINAL LINE: [StructLayout(LayoutKind.Sequential, Pack = 1)] public unsafe struct UpgradeInfo
...
//
//		public const int SIZE = sizeof(uint) + MAX_NAME_LENGTH * sizeof(byte) + sizeof(uint) + sizeof(uint) + sizeof(uint) + MAX_BUTTON_ART_LENGTH * sizeof(byte);
//
