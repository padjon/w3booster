...
//ORIGINAL LINE: [StructLayout(LayoutKind.Sequential, Pack = 1)] public unsafe struct ShopInfo
...
//
//		public const int SIZE = sizeof(uint) + MAX_NAME_LENGTH * sizeof(byte) + sizeof(uint) + sizeof(uint) + MAX_GOODS * ShopGoodInfo.SIZE;
//
...
//
//		[MarshalAs(UnmanagedType.ByValTStr, SizeConst = MAX_NAME_LENGTH)] private fixed byte goods[MAX_GOODS * ShopGoodInfo.SIZE];
//
//		public string Name
//		{
//			get
